window["AFFWP"] = window["AFFWP"] || {}; window["AFFWP"]["portal"] = window["AFFWP"]["portal"] || {}; window["AFFWP"]["portal"]["core"] =
...
/*!***************************!*\
  !*** ./src/core/index.js ***!
  \***************************/
/*! exports provided: fetch, store, copyToClipboard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _affiliatewp_portal_storage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @affiliatewp-portal/storage */ "@affiliatewp-portal/storage");
/* harmony import */ var _affiliatewp_portal_storage__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_affiliatewp_portal_storage__WEBPACK_IMPORTED_MODULE_4__);
/* harmony reexport (default from non-harmony) */ __webpack_require__.d(__webpack_exports__, "store", function() { return _affiliatewp_portal_storage__WEBPACK_IMPORTED_MODULE_4___default.a; });
...
/* harmony import */ var _affiliatewp_portal_clipboard_helpers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @affiliatewp-portal/clipboard-helpers */ "./src/clipboard-helpers/clipboard-helpers.js");
...
/* harmony import */ var _affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @affiliatewp-portal/url-helpers */ "./src/url-helpers/url-helpers.js");
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/alpine.js");
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(alpinejs__WEBPACK_IMPORTED_MODULE_10__);
...
var fetch = _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default.a; // Set up REST URL middleware.

fetch.use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default.a.createRootURLMiddleware(affwp_portal_vars.rest_url)); // Set up Nonce middleware.

fetch.use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default.a.createNonceMiddleware(affwp_portal_vars.nonce)); // Set up Affiliate ID middleware.

fetch.use(function (options, next) {
  ...
  if (Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_3__["hasQueryArg"])(options.path) || options.data && options.data.affiliate_id) {
    return next(options);
  ...
  if (typeof options.method === 'undefined' || 'get' === options.method.toLowerCase()) {
    options.path = Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_3__["addQueryArgs"])(options.path, {
...
fetch.use(function (options, next) {
  ...
  var stableOptions = options; // Sort the path params

  if (undefined !== stableOptions.path) {
    stableOptions.path = Object(_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_9__["getStablePath"])(stableOptions.path);
  } // Sort the options object


  var sortedOptions = Object.keys(stableOptions).sort().reduce(function (acc, key) {
    acc[key] = stableOptions[key];
    return acc;
  }, {}); // Create the hash from the sorted option data.

  var storageHash = "apifetch-".concat(md5__WEBPACK_IMPORTED_MODULE_5___default()(JSON.stringify(sortedOptions))); // Attempt to fetch the data from the store.

  var storageValue = _affiliatewp_portal_storage__WEBPACK_IMPORTED_MODULE_4___default.a.get(storageHash, false); // If we found the item in storage, return the result directly.
  ...
  var result = next(options); // Store the response in the cache for later use.

  _affiliatewp_portal_storage__WEBPACK_IMPORTED_MODULE_4___default.a.set(storageHash, result);
  return result;
});
/**
...
var copyToClipboard = function copyToClipboard() {
  return {
    defaultCopyMessage: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Copy', 'affiliatewp-affiliate-portal'),
    copyMessage: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Copy', 'affiliatewp-affiliate-portal'),
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_affiliatewp_portal_clipboard_helpers__WEBPACK_IMPORTED_MODULE_6__["copy"])(content);

              case 3:
                _this.copyMessage = "\uD83C\uDF89 ".concat(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Copied!', 'affiliatewp-affiliate-portal'));
                _context.next = 9;
                break;
              ...
              case 6:
                ...
                _this.copyMessage = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Could not copy to clipboard', 'affiliatewp-affiliate-portal');
              ...
              case 11:
                _this.copyMessage = _this.defaultCopyMessage;
...
(function() { module.exports = window["AFFWP"]["portal"]["storage"]; }());
